...
export interface AnalysisStageOutputMap {
  "architecture-overview": ArchitectureOverviewStageOutput;
  "dependency-analysis": DependencyAnalysis;
  "folder-explanation": FolderExplanationStageOutput;
  "code-smell-review": CodeSmellReviewStageOutput;
  recommendations: RecommendationsStageOutput;
  "readme-generation": ReadmeGenerationStageOutput;
}

export interface AnalysisStageDefinition<TStageId extends AnalysisStageId> {
  id: TStageId;
  title: string;
  objective: string;
...
export const ANALYSIS_STAGE_DEFINITIONS: {
  [StageId in AnalysisStageId]: AnalysisStageDefinition<StageId>;
} = {
